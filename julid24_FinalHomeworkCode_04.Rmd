...
Z.prop.test <- function(p1, n1, p2 = NULL, n2 = NULL, p0, alternative = "two.sided", conf.level = 0.95) {
  ...
  # Calculate point estimates using the p-hat formula
  p_hat1 <- p1
  se1 <- sqrt(p1 * (1 - p1) / n1)
  ...
  if (is.null(p2) || is.null(n2)) {
    ...
    z <- (p_hat1 - p_hat2) / se_diff
  }
  
  # Calculate p-value based on the specified alternative
...
# Example usage:
# One-sample Z-test
# result1 <- Z.prop.test(p1 = 0.6, n1 = 100, p0 = 0.5)
# print(result1)

# Two-sample Z-test
# result2 <- Z.prop.test(p1 = 0.6, n1 = 100, p2 = 0.55, n2 = 120, p0 = 0.5, alternative = "greater")
# print(result2)
```
